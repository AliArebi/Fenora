...
export function MobileNav() {
  ...
  return <nav className="safe-bottom fixed inset-x-0 bottom-0 z-40 grid grid-cols-4 border-t border-border bg-[#0d0f13]/95 px-2 pt-2 backdrop-blur-xl lg:hidden" aria-label={t('navigation.primary')}>
